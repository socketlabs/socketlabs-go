...
func main() {
	...
	basic.Subject = "Sending An Email With Meta Data"
	...
	metadata1 := message.NewMetadata("My-Meta-Data", "1...2...3...")
	metadata2 := message.NewMetadata("Example-Type", "BasicSendWithMetaData")
	basic.Metadatas = append(basic.Metadatas, metadata1, metadata2)
